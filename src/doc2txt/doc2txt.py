...
from doc_adapter import DocAdapter
from common import *
import os
...
class Doc2Txt:
    def __init__(self):
        ...
        self.adapterMapper[".doc"] = DocAdapter()
    ...
    def parse_dir(self, dir_path, out_dir=None):
        ...
        for fileName in files_in_dir:
            ...
            try:
                target_path = os.path.join(out_dir, fileName + '.txt')
...
if __name__ == '__main__':
    Doc2Txt().parse_dir(PURE_REQ_DIR, PURE_REQ_DIR)
